      ...
      <section className="panel">
        ...
        <div className="algorithm-copy">
          <p>
            ...
            再把近 7 天非 0 活跃日球员排在前组、0 活跃日球员排在后组。前组应用补偿和防重复规则后，
            与后组一起生成完整顺序。
          </p>
          <p>
          ...
          <p>
            第一、第二名的计算方式是：先看近 7 天非 0 活跃日球员组成的前组；如果昨天最终垫底 2 人仍在前组，
            他们会先进入第一、第二名候选队列；候选队列内部再比较今天的加权签号，签号更小的排更前。
            如果候选结果和昨天前 2 名完全相同，就把今天第 3 名提到第 2 名。0 天球员不会进入第一、第二名候选，
            除非当天非 0 天球员不足 2 人。
          </p>
          <p>
