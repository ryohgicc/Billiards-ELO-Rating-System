const exampleRows = [
  ...
  { label: "A 获胜后变化", playerA: "+16", playerB: "-16" },
  { label: "赛后积分", playerA: "1016", playerB: "984" },
];
    ...
    <div className="stack">
      <section className="panel">
        <div className="section-heading">
          ...
          <span className="section-note">初始分 1000 / K 值 32</span>
        </div>

        <div className="algorithm-copy">
          <p>
            这个系统使用 Elo 评分来计算台球排名。每位新球员从 1000 分开始，每场比赛只记录胜者和负者。
            胜者加分，负者扣分；如果低分球员击败高分球员，会获得更多积分。
          </p>
          <p>
      ...
      <section className="panel">
        ...
        <p className="algorithm-note">
          因为双方赛前都是 1000 分，系统认为两人胜率相同。A 获胜后得到 16 分，B 扣 16 分。
          如果 A 原本明显更高分，A 获胜会加得更少；如果 B 是低分反胜高分，会加得更多。
        </p>
      </section>
    </div>
  );
